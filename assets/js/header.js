        ...
        <header class="header border-4 border-primary border-top position-fixed start-0 top-0 w-100">
            ...
            <div class="header-wrapper d-flex align-items-center justify-content-between">
                ...
                <a href="index.html" class="logo-white">
                    <img src="../assets/images/logos/logo-white-alt.svg" style="width: 96px;" alt="logo" class="img-fluid">
                </a>
                <a href="index.html" class="logo-dark">
                    <img src="../assets/images/logos/logo-dark-alt.svg" style="width: 96px;" alt="logo" class="img-fluid">
                </a>
                </div>
                ...
                <div class="btn-group">
                    ...
                    <iconify-icon icon="solar:menu-dots-bold" class="menu-icon fs-10 text-dark"></iconify-icon>
                    </button>
