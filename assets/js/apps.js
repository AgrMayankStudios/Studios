...
// Planets ar App Component
class App_6 extends HTMLElement {
  constructor() {
    super();
  }
  ...
  connectedCallback() {
    this.innerHTML = `
      <div class="portfolio d-flex flex-column gap-6">
        <div class="portfolio-img position-relative overflow-hidden">
          <img src="../assets/images/portfolio/planets-ar/banner.webp" alt="" class="img-fluid"
            style="border-radius: 4px;">
          <div class="portfolio-overlay">
            <a href="https://planetsar.agrmayank.com/" target="_blank" rel="noopener noreferrer"
              class="position-absolute top-50 start-50 translate-middle bg-primary round-64 rounded-circle hstack justify-content-center">
              <iconify-icon icon="lucide:arrow-up-right" class="fs-8 text-dark"></iconify-icon>
            </a>
          </div>
        ...
        <div class="portfolio-details d-flex flex-column gap-3">
          <h3 class="mb-0">Planets AR</h3>
          <div class="hstack gap-2">
            <a class="badge text-dark border"
              href="https://play.google.com/store/apps/details?id=com.AgrMayank.PlanetsAR" target="_blank"
              rel="noopener noreferrer">Android
              <iconify-icon icon="lucide:arrow-up-right" class="text-dark"></iconify-icon></a>
            <a class="badge text-dark border"
              href="https://apps.apple.com/us/app/planets-ar-our-solar-system/id6483760783" target="_blank"
              rel="noopener noreferrer">iOS
              <iconify-icon icon="lucide:arrow-up-right" class="text-dark"></iconify-icon></a>
          </div>
          <div class="hstack gap-2">
            <a class="badge text-dark border"
              href="https://play.google.com/store/apps/details?id=com.AgrMayank.PlanetsAR.JioGlass"
...
customElements.define('app-planetsar', App_6);
